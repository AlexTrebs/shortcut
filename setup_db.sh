...
# wget $SPELLFIX_URL -O extensions/spellfix1.c
# gcc -shared -o extensions/spellfix1.so extensions/spellfix1.c -fPIC -I/usr/include
...
rm -rf SQLite-trunk* SQLite-trunk.tgz
